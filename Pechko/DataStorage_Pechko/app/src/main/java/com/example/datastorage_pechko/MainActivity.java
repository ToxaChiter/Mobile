package com.example.datastorage_pechko;
            ...
            public void onClick(View v)
            {
                ...
                if (!inputID.isEmpty())
                {
                            ...
                            ContextCompat.checkSelfPermission(MainActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)
                    {
                        ...
                        Toast.makeText(MainActivity.this, "Необходимо предоставить разрешение для скачивания файлов", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(MainActivity.this, "Скачивание журнала...", Toast.LENGTH_SHORT).show();
                        downloadJournal(inputID);
                    }
                } else {
                    // Показываем сообщение об ошибке
                    android.widget.Toast.makeText(MainActivity.this, "Введите ID журнала", android.widget.Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private class DownloadFileAsync extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params)
        {
            ...
            try {
                ...
                output.close();
                input.close();
                return "Файл PDF сохранен в Загрузки (Pechko)";
