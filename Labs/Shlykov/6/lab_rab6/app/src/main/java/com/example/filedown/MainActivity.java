...
public class    MainActivity extends AppCompatActivity
{
    ...
    private class DownloadFileAsync extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params)
        {
            ...
            try {
                ...
                output.close();
                input.close();
                return "File PDF saved in Download";
    ...
    public void openPdfFile()
    {
        ...
        if (!file.exists())
        {
            Toast.makeText(this, "There is no such file", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(this, "Error with file opening", Toast.LENGTH_SHORT).show();
        }
    }
