...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 133, ; uint32_t number_of_assemblies_in_apk (0x85)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 618, ; uint32_t number_of_dso_cache_entries (0x26a)
	i32 33555141, ; uint32_t android_runtime_jnienv_class_token (0x20002c5)
	i32 100670641, ; uint32_t jnienv_initialize_method_token (0x6001cb1)
	i32 100670640, ; uint32_t jnienv_registerjninatives_method_token (0x6001cb0)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [618 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 1541521, ; hash 0x178591, from name: libaot-Newtonsoft.Json.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Newtonsoft.Json.dll.so
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.52_name, ; name: libaot-Xamarin.GooglePlayServices.Maps.dll.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.90_name, ; name: libaot-System.Runtime.Serialization.Primitives.dll.so
		ptr null; void* handle (0x0)
	}, ; 12
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.56_name, ; name: libaot-Microsoft.CSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 20
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.17_name, ; name: libaot-Microsoft.Maui.Controls.Maps.dll.so
		ptr null; void* handle (0x0)
	}, ; 22
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.50_name, ; name: libaot-Xamarin.GooglePlayServices.Base.dll.so
		ptr null; void* handle (0x0)
	}, ; 25
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.84_name, ; name: libaot-System.Reflection.Emit.Lightweight.dll.so
		ptr null; void* handle (0x0)
	}, ; 30
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.98_name, ; name: libaot-System.Xml.ReaderWriter.dll.so
		ptr null; void* handle (0x0)
	}, ; 35
	%struct.DSOCacheEntry {
		i64 274845747, ; hash 0x1061d033, from name: System.Runtime.Serialization.Formatters.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.89_name, ; name: libaot-System.Runtime.Serialization.Formatters.dll.so
		ptr null; void* handle (0x0)
	}, ; 36
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.93_name, ; name: libaot-System.Text.Encoding.Extensions.dll.so
		ptr null; void* handle (0x0)
	}, ; 40
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.51_name, ; name: libaot-Xamarin.GooglePlayServices.Basement.dll.so
		ptr null; void* handle (0x0)
	}, ; 48
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.83_name, ; name: libaot-System.Reflection.Emit.ILGeneration.dll.so
		ptr null; void* handle (0x0)
	}, ; 78
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.85_name, ; name: libaot-System.Reflection.Primitives.dll.so
		ptr null; void* handle (0x0)
	}, ; 82
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.65_name, ; name: libaot-System.Data.Common.dll.so
		ptr null; void* handle (0x0)
	}, ; 91
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Microsoft.Maui.Maps.dll.so
		ptr null; void* handle (0x0)
	}, ; 120
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.99_name, ; name: libaot-System.Xml.XDocument.dll.so
		ptr null; void* handle (0x0)
	}, ; 126
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1148300887, ; hash 0x4471ae57, from name: Lab1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lab1.dll.so
		ptr null; void* handle (0x0)
	}, ; 152
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1278588270, ; hash 0x4c35b56e, from name: Lab1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lab1.dll.so
		ptr null; void* handle (0x0)
	}, ; 168
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.53_name, ; name: libaot-Xamarin.GooglePlayServices.Tasks.dll.so
		ptr null; void* handle (0x0)
	}, ; 198
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.97_name, ; name: libaot-System.Xml.Linq.dll.so
		ptr null; void* handle (0x0)
	}, ; 213
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3062992171, ; hash 0xb6918d2b, from name: libaot-Lab1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lab1.dll.so
		ptr null; void* handle (0x0)
	}, ; 460
	...
	%struct.DSOCacheEntry {
		i64 3325064204, ; hash 0xc630740c, from name: libaot-Lab1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lab1.dll.so
		ptr null; void* handle (0x0)
	}, ; 491
	...
	%struct.DSOCacheEntry {
		i64 3666560739, ; hash 0xda8b46e3, from name: aot-Lab1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lab1.dll.so
		ptr null; void* handle (0x0)
	}, ; 537
	...
	%struct.DSOCacheEntry {
		i64 3853208024, ; hash 0xe5ab49d8, from name: aot-Lab1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Lab1.dll.so
		ptr null; void* handle (0x0)
	}, ; 558
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [133 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
...
@.env.3 = private unnamed_addr constant [37 x i8] c"f26cc674-bc76-4882-a938-a0b8e211cb7e\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [21 x i8] c"com.companyname.lab1\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [19 x i8] c"libaot-Lab1.dll.so\00", align 1
...
@.DSOCacheEntry.17_name = private unnamed_addr constant [43 x i8] c"libaot-Microsoft.Maui.Controls.Maps.dll.so\00", align 1
...
@.DSOCacheEntry.22_name = private unnamed_addr constant [34 x i8] c"libaot-Microsoft.Maui.Maps.dll.so\00", align 1
@.DSOCacheEntry.23_name = private unnamed_addr constant [30 x i8] c"libaot-Newtonsoft.Json.dll.so\00", align 1
...
@.DSOCacheEntry.50_name = private unnamed_addr constant [46 x i8] c"libaot-Xamarin.GooglePlayServices.Base.dll.so\00", align 1
@.DSOCacheEntry.51_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Basement.dll.so\00", align 1
@.DSOCacheEntry.52_name = private unnamed_addr constant [46 x i8] c"libaot-Xamarin.GooglePlayServices.Maps.dll.so\00", align 1
@.DSOCacheEntry.53_name = private unnamed_addr constant [47 x i8] c"libaot-Xamarin.GooglePlayServices.Tasks.dll.so\00", align 1
...
@.DSOCacheEntry.56_name = private unnamed_addr constant [31 x i8] c"libaot-Microsoft.CSharp.dll.so\00", align 1
...
@.DSOCacheEntry.65_name = private unnamed_addr constant [33 x i8] c"libaot-System.Data.Common.dll.so\00", align 1
...
@.DSOCacheEntry.83_name = private unnamed_addr constant [50 x i8] c"libaot-System.Reflection.Emit.ILGeneration.dll.so\00", align 1
@.DSOCacheEntry.84_name = private unnamed_addr constant [49 x i8] c"libaot-System.Reflection.Emit.Lightweight.dll.so\00", align 1
@.DSOCacheEntry.85_name = private unnamed_addr constant [43 x i8] c"libaot-System.Reflection.Primitives.dll.so\00", align 1
...
@.DSOCacheEntry.89_name = private unnamed_addr constant [54 x i8] c"libaot-System.Runtime.Serialization.Formatters.dll.so\00", align 1
@.DSOCacheEntry.90_name = private unnamed_addr constant [54 x i8] c"libaot-System.Runtime.Serialization.Primitives.dll.so\00", align 1
...
@.DSOCacheEntry.93_name = private unnamed_addr constant [46 x i8] c"libaot-System.Text.Encoding.Extensions.dll.so\00", align 1
...
@.DSOCacheEntry.97_name = private unnamed_addr constant [30 x i8] c"libaot-System.Xml.Linq.dll.so\00", align 1
@.DSOCacheEntry.98_name = private unnamed_addr constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 1
@.DSOCacheEntry.99_name = private unnamed_addr constant [35 x i8] c"libaot-System.Xml.XDocument.dll.so\00", align 1
