package com.example.mynotes_makarevich;
...
import com.example.mynotes_makarevich.DB.DB;
...
public class MainActivity extends AppCompatActivity{
    ...
    public void onClickAdd(View view) {
        ...
        Toast.makeText(this, "Запись добавлена в базу данных (Макаревич)", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onClickUpDate(View view) {
        ...
        if (db.containRecById(id)) {
            ...
            Toast.makeText(this, "Запись изменена (Макаревич)", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(this, "Такой записи нет в базе данных", Toast.LENGTH_SHORT).show();
        }
