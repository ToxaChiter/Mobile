package com.example.calculator_makarevich;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NoeditText = findViewById(R.id.Makarevich);
            ...
            switch (operator) {
                ...
                case "÷":
                    if (Double.parseDouble(newNumber) == 0) {
                        Toast.makeText(MainActivity.this, "Деление на ноль невозможно (Макаревич)", Toast.LENGTH_LONG).show();
                    } else {
                        resultNumber = Double.parseDouble(oldNumber) / Double.parseDouble(newNumber);
                    }
                    break;
            }
            editText.setText(resultNumber + " (Makarevich)");
        }
    }
