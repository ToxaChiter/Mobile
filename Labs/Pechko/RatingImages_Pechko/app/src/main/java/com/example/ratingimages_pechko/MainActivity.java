package com.example.ratingimages_pechko;
...
public class MainActivity extends AppCompatActivity
{
    ...
    public void GetSearchText(View view)
    {
        ...
        if (!userInput.isEmpty())
        {
            ...
            Picasso.get().load(R.drawable.cheetah).into(imageView);
        }
    }
    ...
    {
        Toast.makeText(MainActivity.this, "Нравится(Pechko)", Toast.LENGTH_SHORT).show();
    ...
    {
        Toast.makeText(MainActivity.this, "Не нравится(Pechko)", Toast.LENGTH_SHORT).show();
