...
import com.example.mynotes_pechko.DB.DB;
...
public class MainActivity extends AppCompatActivity{
    ...
    public void onClickAdd(View view) {
        ...
        if (description.isEmpty()) {
            Toast.makeText(this, "Введите описание (Pechko)", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        Toast.makeText(this, "Запись добавлена в базу данных (Pechko)", Toast.LENGTH_SHORT).show();
    }

    public void onClickDel(View view) {
        EditText editTextNodeId = findViewById(R.id.editTextNoteId);
        String idText = editTextNodeId.getText().toString();
    ...
    public void onClickUpDate(View view) {
        ...
        if (db.containRecById(id)) {
            ...
            Toast.makeText(this, "Запись изменена (Pechko)", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(this, "Такой записи нет в базе данных", Toast.LENGTH_SHORT).show();
        }
